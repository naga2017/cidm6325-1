<?php
/*
Plugin Name: Naga Darksky Weather
Retrieved from Plugin URI: https://github.com/ahuimanu/AhuimanuDarkSkyWeather
Description: Reads the DarkSky REST API and Provides a shortcode and widget. Also does Google Reverse Goecoding.
Version: 1.0
Author: Jeffry Babb
Author URI: http://github.com/ahuimanu/
Text Domain: ahuimanu-plugin
License: GPLv3
 */

register_activation_hook(__FILE__, 'naga_darksky_weather_install');

function naga_darksky_weather_install(){
    global $wp_version;
...
register_deactivation_hook(__FILE__, 'naga_darksky_weather_deactivate');

function naga_darksky_weather_deactivate(){
    //do something when deactivating
}


add_shortcode( 'forecast', 'get_darksky_json_shortcode' );
/**
* @param $atts
* @param null $content
* @return string
...
$url = 'https://api.darksky.net/forecast/65a4e64857f31cd46eba9583616a2a7f/37.8267,-122.4233';
...
add_action( 'widgets_init', 'naga_darksky_weather_create_widgets' );

function naga_darksky_weather_create_widgets() {
	register_widget( 'Naga_DarkySky_Weather' );
}

class Naga_DarkySky_Weather extends WP_Widget {
	// Construction function
	function __construct () {
		parent::__construct( 'Naga_DarkySky_Weather', 'DarkSky Weather',
			array( 'description' =>
	...
	function widget( $args, $instance ) {
		...
		echo "Weather information for San Francisco, CA:";
